...
/*    Image imgsound;
    Sprite spsound; */
    MenuScreen(WoodenBlocks objmidlet)
    {
...
//            imgsound=Image.createImage("/sound.png");
            ...
            int ww=(width/2)-(spbtn1.getWidth()/2);
            spbtn1.setPosition(ww,100);
            spbtn2.setPosition(ww,160);
            spbtn3.setPosition(ww,220);
...
//            spsound.setPosition((width/2)-25,0);
            ...
            sp1.setPosition(50,80);
            sp2.setPosition(120,80);
            sp3.setPosition(190,80);
            sp4.setPosition(50,150);
            sp5.setPosition(120,150);
            sp6.setPosition(190,150);
            sp7.setPosition(50,220);
            sp8.setPosition(120,220);
            sp9.setPosition(190,220);
            sp10.setPosition(50,290);
            sp11.setPosition(120,290);
            sp12.setPosition(190,290);
        }
    ...
    private void handlecategevent(int x,int y)
    {
            ...
            {
                if(objmidlet.unlockedlevel>=1)
                {
//                    hg.startLevel(1);
                    this.objmidlet.showCanvaslevel(1);                    
                }
            }    
            else if(x>=sp2.getX() && x<=sp2.getWidth()+sp2.getX() && y>=sp2.getY() && y<=sp2.getHeight()+sp2.getY())
            {
...
//        spsound.setFrame(0);
        ...
        {
                currentscene=4;
                objmidlet.exitMIDlet(false);
        }
/*        else if(x>=spsound.getX() && x<=spsound.getWidth()+spsound.getX() && y>=spsound.getY() && y<=spsound.getHeight()+spsound.getY())
        {
                if(objmidlet.soundstate==true)
                {
                    spsound.setFrame(1);
                    objmidlet.soundstate=false;
                }
                else
                {
                    spsound.setFrame(0);
                    objmidlet.soundstate=true;
                }
        }
 */
        repaint();
...
//        spsound.paint(g);
    ...
    private void cat(Graphics g)
    {
        ...
        g.drawString("4",x1+(w/2),y2+(h/2)-(g.getFont().getHeight()/2),Graphics.HCENTER|Graphics.TOP);
        g.drawString("5",x2+(w/2),y2+(h/2)-(g.getFont().getHeight()/2),Graphics.HCENTER|Graphics.TOP);
        g.drawString("6",x3+(w/2),y2+(h/2)-(g.getFont().getHeight()/2),Graphics.HCENTER|Graphics.TOP);
        g.drawString("7",x1+(w/2),y3+(h/2)-(g.getFont().getHeight()/2),Graphics.HCENTER|Graphics.TOP);
        g.drawString("8",x2+(w/2),y3+(h/2)-(g.getFont().getHeight()/2),Graphics.HCENTER|Graphics.TOP);
        g.drawString("9",x3+(w/2),y3+(h/2)-(g.getFont().getHeight()/2),Graphics.HCENTER|Graphics.TOP);
        g.drawString("10",x1+(w/2),y4+(h/2)-(g.getFont().getHeight()/2),Graphics.HCENTER|Graphics.TOP);
        g.drawString("11",x2+(w/2),y4+(h/2)-(g.getFont().getHeight()/2),Graphics.HCENTER|Graphics.TOP);
        g.drawString("12",x3+(w/2),y4+(h/2)-(g.getFont().getHeight()/2),Graphics.HCENTER|Graphics.TOP);
    }
}