...
//$$IncludeStyleSheetDefinitionHere$$//
	...
	public static Style middlecommandStyle;
	...
	static final Hashtable stylesByName = new Hashtable(61);
static { // init styles:
	initStyles0();
}
private static final void initStyles0(){
	...
	leftcommandStyle = new Style (
		...
		null,	// no background
		null, 	// no border
		new short[]{ 32712, -10, -9, -14, -17, -15, 89, 88},
		new Object[]{ new Dimension(0, false), new Dimension(0, false), new Dimension(7, false), new Integer(Font.STYLE_BOLD), new Color( 0xFFFFFF, false), new Integer( Font.SIZE_SMALL ), new Color( 0x333333, false), new de.enough.polish.ui.texteffects.ShadowTextEffect()}
	);
	...
	middlecommandStyle = new Style (
		"middlecommand", 
		Item.LAYOUT_DEFAULT,	// default layout
		null,	// no background
		null, 	// no border
		new short[]{ -10, -9, -14, -17, -15, 32712, 89, 88},
		new Object[]{ new Dimension(0, false), new Dimension(1, false), new Integer(Font.STYLE_BOLD), new Color( 0x000000, false), new Integer( Font.SIZE_SMALL ), new Dimension(0, false), new Color( 0x333333, false), new de.enough.polish.ui.texteffects.ShadowTextEffect()}
	);
	...
	stylesByName.put( "middlecommand", middlecommandStyle );
